...
function seed() {
  ...
  db.items.push(
    {
      ...
      location: 'Herrera Hall', date_lost: dateStr(2), image_url: 'https://placehold.co/600x400/3B82F6/ffffff?text=Samsung+Galaxy',
    ...
    },
    {
      ...
      location: 'Mentrida Hall', date_lost: dateStr(5), image_url: 'https://placehold.co/600x400/111827/ffffff?text=Black+Backpack',
    ...
    },
    {
      ...
      location: 'Gymnasium', date_lost: dateStr(1), image_url: 'https://placehold.co/600x400/EF4444/ffffff?text=USA+ID+Card',
    ...
    },
    {
      ...
      location: 'Rada Hall', date_lost: dateStr(8), image_url: 'https://placehold.co/600x400/4B5563/ffffff?text=Calculator',
    ...
    },
    {
      ...
      location: 'Fray Luis De Leon Hall', date_lost: dateStr(16), image_url: 'https://placehold.co/600x400/8B5CF6/ffffff?text=Eyeglasses',
      verification_question: null,
      user_name: 'Juan Dela Cruz', user_email: 'student@usa.edu.ph',
    ...
    },
    {
      ...
      location: 'Mendel Hall', date_lost: dateStr(3), image_url: 'https://placehold.co/600x400/F59E0B/ffffff?text=Chemistry+Book',
  ...
  db.items.push(
    {
      ...
      location: 'Parking Lot', date_lost: dateStr(1), image_url: 'https://placehold.co/600x400/9CA3AF/ffffff?text=Keys',
    ...
    },
    {
      ...
      location: 'Grandstand', date_lost: dateStr(3), image_url: 'https://placehold.co/600x400/60A5FA/ffffff?text=Hydroflask',
    ...
    },
    {
      ...
      location: 'Injap Center', date_lost: dateStr(4), image_url: 'https://placehold.co/600x400/1F2937/ffffff?text=USB+Drive',
  ...
  db.items.push({
    ...
    location: 'Swimming Pool Area', date_lost: dateStr(12), image_url: 'https://placehold.co/600x400/EF4444/ffffff?text=Red+Umbrella',
